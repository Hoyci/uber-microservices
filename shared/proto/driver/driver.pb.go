...
const file_driver_proto_rawDesc = "" +
	...
	"\x06driver\x18\x01 \x01(\v2\f.trip.DriverR\x06driver\"\xd8\x01\n" +
	"\x06Driver\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12&\n" +
	"\x0eprofilePicture\x18\x03 \x01(\tR\x0eprofilePicture\x12\x1a\n" +
	"\bcarPlate\x18\x04 \x01(\tR\bcarPlate\x12 \n" +
	"\vpackageSlug\x18\x05 \x01(\tR\vpackageSlug\x12\x18\n" +
	"\ageohash\x18\x06 \x01(\tR\ageohash\x12*\n" +
	"\blocation\x18\a \x01(\v2\x0e.trip.LocationR\blocation\"D\n" +
	"\bLocation\x12\x1a\n" +
	"\blatitude\x18\x01 \x01(\x01R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude2\xab\x01\n" +
	"\rDriverService\x12K\n" +
	"\x0eRegisterDriver\x12\x1b.trip.RegisterDriverRequest\x1a\x1c.trip.RegisterDriverResponse\x12M\n" +
	"\x10UnregisterDriver\x12\x1b.trip.RegisterDriverRequest\x1a\x1c.trip.RegisterDriverResponseB\x1cZ\x1ashared/proto/driver;driverb\x06proto3"
...
var file_driver_proto_goTypes = []any{
	(*RegisterDriverRequest)(nil),  // 0: trip.RegisterDriverRequest
	(*RegisterDriverResponse)(nil), // 1: trip.RegisterDriverResponse
	(*Driver)(nil),                 // 2: trip.Driver
	(*Location)(nil),               // 3: trip.Location
}
var file_driver_proto_depIdxs = []int32{
	2, // 0: trip.RegisterDriverResponse.driver:type_name -> trip.Driver
	3, // 1: trip.Driver.location:type_name -> trip.Location
	0, // 2: trip.DriverService.RegisterDriver:input_type -> trip.RegisterDriverRequest
	0, // 3: trip.DriverService.UnregisterDriver:input_type -> trip.RegisterDriverRequest
	1, // 4: trip.DriverService.RegisterDriver:output_type -> trip.RegisterDriverResponse
	1, // 5: trip.DriverService.UnregisterDriver:output_type -> trip.RegisterDriverResponse
